...
{
    class Fussbereich : ZeichenbereichBase
    {
        private int _aktuellX = 0;
        private int _aktuellY = Console.WindowHeight - Console.WindowHeight / 2 / 2 + 1;
        ...
        public override int StartY { get { return Console.WindowHeight - Console.WindowHeight / 2 / 2 + 1; } }
