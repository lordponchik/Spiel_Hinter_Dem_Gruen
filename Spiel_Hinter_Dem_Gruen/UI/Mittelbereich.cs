...
{
    class Mittelbereich : ZeichenbereichBase
    {
        private int _aktuellX = 0;
        private int _aktuellY = Console.WindowHeight / 2;
        public override int StartX { get { return 0; } }
        public override int StartY { get { return Console.WindowHeight / 2; } }

        public override int EndeX { get { return Console.WindowWidth / 3 * 2 - 1; } }
        public override int EndeY { get { return Console.WindowHeight - Console.WindowHeight / 2 / 2 + 1; } }
